...
def cal_d_loss(fake_score: torch.Tensor, real_score: torch.Tensor, loss_func: Callable = nn.BCELoss()) -> torch.Tensor:
...
def cal_g_loss(fake_score: torch.Tensor, loss_func=nn.BCELoss()) -> torch.Tensor:
